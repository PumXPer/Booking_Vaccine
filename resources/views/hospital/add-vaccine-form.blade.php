...
<main>
    ...
    <nav>
        <ul>
            <li><a href="{{ route('hospital-manage-vaccine', ['hospitalCode' => $hospital->code,]) }}">&lt; Back</a></li>
        </ul>
    </nav>

    <form action="{{ route('hospital-add-vaccine-form', ['hospitalCode' => $hospital->code,]) }}" method="get">
    <table>
    ...
    <form action="{{ route('hospital-add-vaccine', ['hospitalCode' => $hospital->code,]) }}" method="post">
        @csrf
        <table class="list">
            <tr>
                <th>Code</th>
