...
<main>
    <nav>
        <ul>
        <li><a href="{{ route('type-detail', ['typeCode' => $type->code,]) }}">&lt; Back</a></li>
        </ul>
    </nav>

    <form action="{{ route('type-manage-vaccine', ['typeCode' => $type->code,]) }}" method="get">
    ...
    <nav>
        <ul>
            <li><a href="{{ route('type-add-vaccine-form', ['typeCode' => $type->code,]) }}">Add vaccine</a></li>
        </ul>
    </nav>
